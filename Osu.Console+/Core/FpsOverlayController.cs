namespace Osu.Console.Core
{
    class FpsOverlayController : IGameController
    {
        ...
        void IGameController.PushFrame(GameBuffer buffer)
        {
            ...
            buffer.DrawString(fps, (0, 180, 255), buffer.Width - Math.Max(fps.Length,cost.Length), buffer.Height - 2);
            buffer.DrawString(cost, (0, 180, 255), buffer.Width - Math.Max(fps.Length, cost.Length), buffer.Height - 1);
        }
    }
}
